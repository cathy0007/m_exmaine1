...
export default {
  ...
  */
  install(Vue, options) {
      /*
      *官方文档：Vue.extend： https://cn.vuejs.org/v2/api/#Vue-extend
      *第一步：使用基础 Vue.extend 构造器，创建一个“子类” (Loading)。参数是一个包含组件选项的对象(myLoading)。 
      *第二步：创建一个loading的实例为 Profile，挂载到一个HTMLElement实例上
      */
